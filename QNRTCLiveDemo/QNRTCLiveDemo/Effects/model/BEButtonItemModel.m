...
+ (instancetype)bodyModelWithInternalKey:(NSString *)internalKey {
    if ([internalKey isEqualToString:@"BEF_BEAUTY_BODY_LONG_LEG"]) {
        ...
        return [BEButtonItemModel
         ...
         title:@""];
    } else if ([internalKey isEqualToString:@"BEF_BEAUTY_BODY_SHRINK_HEAD"]) {
        return [BEButtonItemModel
         initWithType:PLSMakeUpComponentTypeBody
         selectImg:@"iconBeautyBodyShrinkHeadSelect"
         unselectImg:@"iconBeautyBodyShrinkHeadNormal"
         title:@""];
    } else if ([internalKey isEqualToString:@"BEF_BEAUTY_BODY_SLIM_LEG"]) {
        return [BEButtonItemModel
         initWithType:PLSMakeUpComponentTypeBody
         selectImg:@"iconBeautyBodySlimLegSelect"
         unselectImg:@"iconBeautyBodySlimLegNormal"
         title:@""];
    } else if ([internalKey isEqualToString:@"BEF_BEAUTY_BODY_SLIM_WAIST"]) {
        return [BEButtonItemModel
         initWithType:PLSMakeUpComponentTypeBody
         selectImg:@"iconBeautyBodyThinSelect"
         unselectImg:@"iconBeautyBodyThinNormal"
         title:@""];
    } else if ([internalKey isEqualToString:@"BEF_BEAUTY_BODY_ENLARGR_BREAST"]) {
        return [BEButtonItemModel
         initWithType:PLSMakeUpComponentTypeBody
         selectImg:@"iconBeautyBodyEnlargeBreastSelect"
         unselectImg:@"iconBeautyBodyEnlargeBreastNormal"
         title:@""];
    } else if ([internalKey isEqualToString:@"BEF_BEAUTY_BODY_ENHANCE_HIP"]) {
        return [BEButtonItemModel
         initWithType:PLSMakeUpComponentTypeBody
         selectImg:@"iconBeautyBodyEnhanceHipSelect"
         unselectImg:@"iconBeautyBodyEnhanceHipNormal"
         title:@""];
    } else if ([internalKey isEqualToString:@"BEF_BEAUTY_BODY_ENHANCE_NECK"]) {
        return [BEButtonItemModel
         initWithType:PLSMakeUpComponentTypeBody
         selectImg:@"iconBeautyBodyEnhanceNeckSelect"
         unselectImg:@"iconBeautyBodyEnhanceNeckNormal"
         title:@""];
    } else if ([internalKey isEqualToString:@"BEF_BEAUTY_BODY_SLIM_ARM"]) {
        return [BEButtonItemModel
         initWithType:PLSMakeUpComponentTypeBody
