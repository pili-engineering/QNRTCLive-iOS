 ...
 */
FOUNDATION_EXPORT NSString *const RCCRKitDispatchMessageNotification;

FOUNDATION_EXPORT NSString *const RCCRConnectChangeNotification;

@interface RCCRRongCloudIMManager : NSObject
